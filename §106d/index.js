...
const onLoad = function () {
    ...
    function requiredFieldValidator(value) {
      ...
      var data = [];
      var columns = [
        {id: "title", name: "Titel", field: "title", width: 120, cssClass: "cell-title", editor: Slick.Editors.Text, validator: requiredFieldValidator},
        {id: "desc", name: "Beschreibung", field: "description", width: 100, editor: Slick.Editors.LongText},
