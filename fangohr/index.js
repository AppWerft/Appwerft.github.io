...
window.onload = function () {
	...
	this.Object.keys(beteiligung).forEach(function (item) {
		$('#beteiligung').append('<li class="drawer-menu-item"><label class="switch"><input checked="1" type="checkbox" name="' + item + '"><span class="slider round"></span></label>' + beteiligung[item] + '</li>')
	}),
